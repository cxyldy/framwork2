...
# 调用接口
url = "https://hldopenapi-app-uat.3vast.net/openapi-mms/split/openBizArea"
# 请求参数
content =  {
...
r = requests.post(url=url, data=json.dumps(content, ensure_ascii=False, separators=(",", ":")).encode('UTF-8'),
