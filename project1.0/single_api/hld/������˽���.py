...
# 调用接口
url = "https://hldopenapi-app-uat.3vast.net/openapi-pay/split/paySplitOnceOrder"
# 请求参数
content = {
    ...
    "reqData": {
        ...
        "oriPayNo": "20220923809000011892870103838351",
        "outOrderNo": "202209230004",
        "rcvMercInfos": {
            "payeeMerchantCode": "809000011892864",
            "rcvAmount": "000000000493",
            "description": "测试分账0021"
        }
    }
}
# 服务商商圈1dD@
