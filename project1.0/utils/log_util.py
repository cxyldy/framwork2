...
project_parth = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
log_path = os.path.join(project_parth, "log")
print(os.path.join(log_path,"{}".format(time.strftime("%Y%m%d"))))
